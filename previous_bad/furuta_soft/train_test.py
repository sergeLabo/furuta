...
gamma = 0.99
gae_lambda = 0.95
clip_range = <function constant_fn.<locals>.func at 0x7fd6c47999d0>
clip_range_vf = None
ent_coef = 0.001
vf_coef = 0.55
max_grad_norm = 0.5
...
def main(numero, train_test):
    ...
    ini_file = current_dir + '/furuta_ai.ini'
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f"Vous devez spécifier le nom de l'apprentissage")
        sys.exit()
